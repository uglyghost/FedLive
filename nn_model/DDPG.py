...
class DDPG(object):
    def __init__(self,
        ...
        self.actor_optimizer = torch.optim.Adam(self.actor.parameters(), lr=1e-3, weight_decay=1e-3)

        self.critic = Critic(state_dim, action_dim).to(device)
        self.critic_target = copy.deepcopy(self.critic)
        self.critic_optimizer = torch.optim.Adam(self.critic.parameters(), lr=1e-3, weight_decay=1e-3)
